...
<body>
    ...
    <div class="w3-top">
        <div class="w3-bar w3-black w3-wide w3-padding w3-card">
            <a href="#home" class="w3-bar-item w3-button"><b>VonMax</b> <span style="color: red;">Digital</span></b></a>
    ...
    <header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">
        ...
        <div class="w3-display-middle w3-margin-top w3-center">
            <h1 class="w3-xxlarge w3-text-white"><span class="w3-padding w3-red w3-opacity-min"><b>VonMax</b></span> <span
                    class="w3-hide-small w3-text-light-grey">| Digital</span></h1>
        </div>
    </header>
